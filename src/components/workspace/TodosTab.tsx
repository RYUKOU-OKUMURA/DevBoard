        ...
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          {todo.status !== 'in_progress' && (
            <button
              ...
              className="p-1 rounded hover:bg-[var(--bg-hover)] text-[var(--accent-blue)]"
              title="進行中にする"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {todo.status !== 'done' && (
            <button
              ...
              className="p-1 rounded hover:bg-[var(--bg-hover)] text-[var(--accent-green)]"
              title="完了にする"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {!todo.issueNumber && onCreateIssue && (
            <button
              ...
              disabled={isSyncing}
              className="p-1 rounded hover:bg-[var(--accent-green-muted)] text-[var(--text-muted)] hover:text-[var(--accent-green)] disabled:opacity-50"
          ...
          <button
            ...
            className="p-1 rounded hover:bg-[var(--accent-red-muted)] text-[var(--text-muted)] hover:text-[var(--accent-red)]"
            title="削除"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
